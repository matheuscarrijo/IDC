...
\newcommand{\fonte}[1]{%
  ...
  \par\small\textit{Fonte: #1}\par\vspace{0.8\baselineskip}%
}
...
Com a publicação, em \textbf{\mespublicacao}, das Estatísticas Monetárias e de Crédito do
Banco Central do Brasil (competência \textbf{\competencia}), o \textbf{Índice de Desconforto
de Crédito (IDC)} foi recalculado e estendido até \textbf{\mesreferencia} --- último mês para
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{9.5cm}rr}
    \toprule
    \textbf{Indicador} & \textbf{Valor bruto} & \textbf{Valor normalizado} \\
    \midrule
    \textbf{IDC} (média dos componentes normalizados)
      & ---
      & \textbf{0,954} \\
...
\begin{itemize}
  \item \textbf{Comprometimento de renda (C)} passou de \textbf{29,6\%} para
    \textbf{29,3\%} (-0,3~p.p.).
  ...
  \item \textbf{Inadimplência (I)} recuou de
  ...
  \item \textbf{Qualidade do crédito (Q)} caiu de
...
Monetárias e de Crédito do Banco Central, esperada para \textbf{\proxdivulgacao}.
...
\textbf{Sobre o IDC.} O Índice de Desconforto de Crédito (IDC) é construído a partir de
...
\textbf{Citação recomendada.} Gonzalez, L.; Schiozer, R.; Carrijo, M.~L.
